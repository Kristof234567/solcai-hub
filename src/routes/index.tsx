    ...
    <footer className="border-t border-border/40 py-12">
      <div className="max-w-6xl mx-auto px-6 flex flex-col md:flex-row md:items-center md:justify-between gap-8">
        ...
        <div className="flex flex-wrap items-center justify-center gap-x-6 gap-y-3 text-sm text-muted-foreground">
          ...
          <Link to="/refund" className="hover:text-foreground transition">Refund</Link>
            <Link to="/delete-data" className="hover:text-foreground transition">Delete data</Link>
            <a href="mailto:support.solcai@gmail.com" className="inline-flex items-center gap-1.5 hover:text-foreground transition">
